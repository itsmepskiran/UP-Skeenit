...
class AuthService:
    ...
    # ---------------------------------------------------------
    # EMAIL CONFIRMATION TOKEN VERIFICATION (NEW)
    # ---------------------------------------------------------
    def verify_email_token(self, token: str, type: str) -> Dict[str, Any]:
        """
        Wrapper for Supabase email confirmation token verification.
        Used by /auth/confirm-email router.
        """
        try:
    ...
    def _send_welcome_email(self, email: str, full_name: str, role: str, company_id: Optional[str] = None) -> Dict[str, Any]:
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p><a href="{site_url}" style="padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 4px;">Go to Login</a></p>
        </div>
        """
        ...
        try:
            ...
            return {"ok": False, "email_sent": False, "error": str(e)}
    ...
    def get_recruiter_company_info(self, user_id: str) -> Dict[str, Any]:
        ...
        if not company_id:
            try:
                ...
                meta = getattr(getattr(user, "user", None), "user_metadata", {}) or {}
